                    ...
                    <?php foreach ($image as $image) { ?>
                        <div class="col-sm-3 text-center">
                            <?php if ($image['type'] == 'directory') { ?>
                                ...
                                <label>
                                    <input type="checkbox" name="path[]" value="<?php echo $image['id']; ?>" />
...
<script type="text/javascript"><!--
    ...
    $('a.thumbnail').on('click', function(e) {
        ...
        $('#<?php echo $target; ?>').attr('value', $(this).find('img').attr('src'));
    ...
    $('#button-search').on('click', function(e) {
        var url = '/file-manager?directory=<?php echo $directory; ?>';
...
<script type="text/javascript"><!--
    $('#button-upload').on('click', function() {
        ...
        timer = setInterval(function() {
            if ($('#form-upload input[name=\'file\']').val() != '') {
                ...
                $.ajax({
                    url: '/file-manager/upload?directory=<?php echo $directory; ?>',
                    type: 'post',
                    dataType: 'json',
    ...
    $('#button-folder').on('shown.bs.popover', function() {
        $('#button-create').on('click', function() {
            $.ajax({
                url: '/file-manager/folder?directory=<?php echo $directory; ?>',
                type: 'post',
                dataType: 'json',
