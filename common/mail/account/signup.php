...
$this->title = 'Your new brrat account is ready!';
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        <strong
                                            ...
                                            <br/>
                                            You're now the proud owner of your very own brrat account
                                            <br/>
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        You can easily log in with the same account you just created and start
                                        ordering online using the brrat app or through our website( <a href="http://brrat.wistech.biz">http://brrat.wistech.biz</a> ) By creating account you can now:
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 15px 5px; text-align: center;"
                                        valign="top">
                                        <a href="http://brrat.wistech.biz/#/account/verify-account/<?= $user->verification_code ?>" class="btn-primary"
