...
class RestException extends Exception
{
    ...
    */
    ...
    /**
     * DESC
     *  Throw an exception if there is any error occured, just pass status, Error message and status code to
     * dataValidationFailed function.
     *
     * Example
     *
     * ~~~
     *  return RestException::dataValidationFailed(422, 'Data validation failed', 0);
     * ~~~
